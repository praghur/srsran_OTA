...
for imsi in {000..003}; do
   ./open5gs-dbctl add_ue_with_slice 999990000000$imsi 00112233445566778899aabbccddeeff 0ed47545168eafe2c39c075829a7b61f internet 2 0x000001 # IMSI,K,OPC
   ./open5gs-dbctl type 999990000000$imsi 1  # APN type IPV4
done

./open5gs-dbctl static_ip 999990000000000 192.168.10.1
./open5gs-dbctl static_ip 999990000000001 192.168.10.2
