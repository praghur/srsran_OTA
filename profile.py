...
def x310_node_pair1(idx, x310_radio):
    node = request.RawPC("{}-gnuradio1-comp".format(x310_radio))
...
def x310_node_pair2(idx, x310_radio):
    node = request.RawPC("{}-gnuradio2-comp".format(x310_radio))
    node.component_manager_id = COMP_MANAGER_ID
    node.hardware_type = params.sdr_nodetype
    ...
    node_radio_if = node.addInterface("usrp_if")
    node_radio_if.addAddress(rspec.IPv4Address("192.168.40.11",
                                               "255.255.255.0"))
...
def x310_node_pair3(idx, x310_radio):
    node = request.RawPC("{}-gnuradio3-comp".format(x310_radio))
    node.component_manager_id = COMP_MANAGER_ID
    node.hardware_type = params.sdr_nodetype
    ...
    node_radio_if = node.addInterface("usrp_if")
    node_radio_if.addAddress(rspec.IPv4Address("192.168.40.21",
                                               "255.255.255.0"))
